#pragma checksum "C:\Users\Emerson\Source\Repos\AutosoftService-ProyectoFinal34\AutosoftService\Pages\Consultas\CCliente.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e9c9733d8c4ff70f94278999915a7da908e9da14"
// <auto-generated/>
        ...
        try
        {
            ...
            else
            {
                if (Filtro != null)
                {
                    ...
                    {
                        case "0":
                            listapaginada = ClienteBLL.GetList(e => true);

                            break;
                        case "1":
                          listapaginada = ClienteBLL.GetList(e => e.ClienteId == Convert.ToInt32(Criterio));
                            break;
                        case "2":
                            listapaginada = ClienteBLL.GetList(e => e.Nombre == Criterio);
                            break;
                        case "3":
                            listapaginada = ClienteBLL.GetList(e => e.Cedula == Criterio);
                            break;
