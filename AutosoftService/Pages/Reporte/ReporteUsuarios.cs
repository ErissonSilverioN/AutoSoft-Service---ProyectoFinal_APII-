...
namespace AutosoftService.Pages.Reporte
{
    public class ReporteUsuarios
    {
        ...
        List<Usuarios> lista = UsuarioBLL.GetList(c => true);
        ...
        private void ReportBody()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("Fecha Ingreso", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.LightGray;
            pdfTable.AddCell(pdfCell);
            ...
            foreach (var item in lista)
            {
                ...
                pdfCell = new PdfPCell(new Phrase(item.Usuario, fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
            ...
            pdfCell = new PdfPCell(new Phrase("Total de Usurios", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.White;
            pdfCell.Border = 0;
